...
<div class="container">
    <div class="years-table-container" style="margin-top: 4.5rem;">
        ...
        <a href="<?= site_url('admin/students/add') ?>" class="btn years-add-btn mb-3">Új tanuló hozzáadása</a>
                ...
                <tbody>
                    <?php foreach ($datas as $data): ?>
                        <tr>
                            ...
                            <td><?= esc($data['educational_id']) ?></td>
                            <td>
                                <a href='<?= site_url("admin/students/update/{$data['id']}"); ?>' title='Módosítás' data-toggle='tooltip' class='btn years-action-btn years-action-btn-warning me-2'>
                                ...
                                <form action='<?= site_url("admin/students/show"); ?>' method='post' style='display: inline;'>
                                    ...
                                    <button type='submit' title='Törlés' data-toggle='tooltip' class='btn years-action-btn years-action-btn-danger me-2'
                                        onclick="return confirm('Biztosan törli a tanulót (<?= esc($data['name']) ?>)?');">
